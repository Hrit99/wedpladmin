...
Future<List<Item>> getAllItems(
    String category, String subcategory, bool reload) async {
  ...
  if (reload == false) {
    resp = pref.getString('admin${category}${subcategory}itemresp');
  } else {
    print("et");
    await http
        .post(
    ...
    //   resp = cacheRes;
    // }
    pref.setString('admin${category}${subcategory}itemresp', resp);
  }
  print("ki;");
  print(resp);
